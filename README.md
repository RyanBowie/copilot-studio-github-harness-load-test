...
**Current state: fourteen reviewed runs, reported on [GitHub Pages](https://ryanbowie.github.io/copilot-studio-github-harness-load-test/).** The newest separate 125-request baseline completed **125 native attempts / 124 greetings / 1 disconnected invocation / 0 pending**, with no skipped, unoffered or retried requests. The first attempt failed; every subsequent request succeeded. The first failure stays in the denominator: **99.2% greeting success**, not zero-error qualification. Actual arrivals lasted **303.08066709999997 s**, about **24.74588719816105 offered RPM**, not a full 25/min result. Of 124 replies, **122 completed before observed arrival end and two during drain**.

All thirteen prior records and their campaign contexts remain unchanged, including the zero-error capacity study that ended on its first transport disconnection with no candidate, higher screens or hours. The earlier full-100 count-bound retest still reports **60 greetings / 40 native failures / 0 pending**, with **39 generic server errors and 1 disconnected call**, **63.522 seconds of arrivals / about 94.455 offered RPM**, and 99 distinct returned conversations. That was not a full 100/minute result or 40 proven backend failures. **No full hour completed and no GitHub Copilot Harness capacity ceiling is established.** Costs remain **pending**, not zero. No Standard Harness data or images are imported. This repository is an offline report, not a cloud test runner; the separate email-to-workflow-to-agent scenario is not implemented.
