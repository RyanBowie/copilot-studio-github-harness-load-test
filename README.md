...
**Current state: fifteen reviewed runs, reported on [GitHub Pages](https://ryanbowie.github.io/copilot-studio-github-harness-load-test/).** The newest continuous-hour ramp stopped after **365 native attempts / 364 greetings / 1 explicit HTTP 429 failure / 0 pending**. It covered only **835.0349769999999 seconds (13m55s)** of the planned hour. The 25 RPM level offered **248/248 greetings over 600 seconds (24.8 actual RPM)**; the 30 RPM level offered **117 attempts / 116 greetings / 1 failure over a partial 235.03497699999997 seconds**. Higher levels were not reached. **1885 unused requests of the 2250 nominal ceiling are not failures. No completed hour or 30 RPM harness-quota conclusion follows.**

All fourteen prior records and their campaign contexts remain unchanged. The separate 125-request baseline remains **124 greetings / 1 initial disconnected failure / 0 pending (99.2%)**, at **24.74588719816105 actual RPM**, not full 25/min or zero-error qualification. The earlier full-100 retest remains **60 greetings / 40 native failures**, at about **94.455 RPM**, not full 100/min. The strict zero-error study still has no candidate after its first transport disconnection. **No full hour completed and no GitHub Copilot Harness capacity ceiling is established.** Costs remain **pending**, not zero. No Standard Harness data or images are imported. This repository is an offline report, not a cloud test runner; the separate email-to-workflow-to-agent scenario is not implemented.
